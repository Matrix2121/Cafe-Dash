...
const CreateUser = () => {
    ...
    return (
        ...
        >
            <CommonHeader title={t("create-user")}/>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.registerContainer}>
                    <Text style={styles.title}>
                        <Text style={styles.highlight}>{t("create-user")}</Text>
                    </Text>
                    ...
                    <HasRoles roles={['admin']}>
                        <View style={styles.selectRolesContainer}>
                            <Text style={styles.selectRolesLabel}>{t("role")}:</Text>
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? 'Creating User...' : t("create-button")}
                    </Button>
                </View>
            </ScrollView>
        </KeyboardAvoidingView>
